...
Core protocol specification. Defines BIND, SEARCH, COMPARE, ADD, DELETE, MODIFY, MODIFY DN, and extended operations.

### RFC 4512 — LDAP: Directory Information Models
Defines the directory information model (DIM), object classes, attribute types, and the X.500 information model adapted for LDAP.
